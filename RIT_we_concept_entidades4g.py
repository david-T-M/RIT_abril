...
#for i in range(4):
    ...
    if c_incompatibilidad!=0:
        new_data['entropias'].append(1000)
        new_data['KL_divergence'].append(1000)
        new_data['max_info'].append(1000)
        new_data['sumas'].append(1000)
        new_data['mearts'].append(1000)
        new_data['mutinf'].append(1000)
        new_data['diferencias'].append(1000)
        new_data['distancias'].append(1000)
    elif ma.shape[1]==0:
...
df_resultados.to_pickle("salida/nuevo4g/"+sys.argv[1]+"_.pickle")
