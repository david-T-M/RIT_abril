...
for i in range(len(textos)):
    ...
    # print(t_clean_m)
    # print(h_clean_m)
    t_lem=ut.get_texts_(textos[i],nlp)
    h_lem=ut.get_texts_(hipotesis[i],nlp)
